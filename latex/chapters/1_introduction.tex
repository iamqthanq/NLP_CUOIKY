...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Baseline: BLEU 32.17\% 
        \item Extension: BLEU 36.24\% (vượt xa yêu cầu, đạt mức tốt)
...
\begin{itemize}
    ...
    \item \textbf{Chương 4 - Kết quả Baseline}: Thiết lập thực nghiệm, kết quả training, BLEU 32.17\%, 5 ví dụ dịch, và phân tích lỗi.
    
    \item \textbf{Chương 5 - Extension: Attention \& Beam Search}: Kiến trúc Attention model, kết quả BLEU 36.24\%, so sánh với Baseline.
